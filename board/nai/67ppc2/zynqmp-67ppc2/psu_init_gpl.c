...
/*##################################################################### */
    ...
    * Selection of TSU Interface clock 0: TSU clock from the PS 1: TSU clock l
    * oop backed from the PL
    *  PSU_IOU_SLCR_GEM_CLK_CTRL_TSU_CLK_LB_SEL                    1

    * SoC Debug Clock Control
    * (OFFSET, MASK, VALUE)      (0XFF180308, 0x00400000U ,0x00400000U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL1_REF_CTRL_DIVISOR0                           0xc
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01010C00U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL2_REF_CTRL_DIVISOR0                           0x3c
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C8, 0x013F3F07U ,0x01013C00U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL3_REF_CTRL_DIVISOR0                           0x2e
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00CC, 0x013F3F07U ,0x01012E00U)
    */
	PSU_Mask_Write(CRL_APB_PL3_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01012E00U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_DP_STC_REF_CTRL_DIVISOR0                        0x1b
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A007C, 0x013F3F07U ,0x01011B03U)
    */
	PSU_Mask_Write(CRF_APB_DP_STC_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01011B03U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * ONLY.
    *  PSU_DDRC_PWRTMG_T_DPD_X4096                                 0x58
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070034, 0x00FFFF1FU ,0x00405810U)
    */
	PSU_Mask_Write(DDRC_PWRTMG_OFFSET, 0x00FFFF1FU, 0x00405810U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_RFSHTMG_T_RFC_NOM_X32                              0x56
    ...
    * d. Unit: Clocks.
    *  PSU_DDRC_RFSHTMG_T_RFC_MIN                                  0x5d

    * Refresh Timing Register
    * (OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0056805DU)
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0056805DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT0_PRE_CKE_X1024                                0xaf

    * SDRAM Initialization Register 0
    * (OFFSET, MASK, VALUE)      (0XFD0700D0, 0xC3FF0FFFU ,0x000200AFU)
    */
	PSU_Mask_Write(DDRC_INIT0_OFFSET, 0xC3FF0FFFU, 0x000200AFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT2_IDLE_AFTER_RESET_X32                         0x18
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700D8, 0x0000FF0FU ,0x00001805U)
    */
	PSU_Mask_Write(DDRC_INIT2_OFFSET, 0x0000FF0FU, 0x00001805U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 1024 clocks.
    *  PSU_DDRC_DRAMTMG0_T_RAS_MAX                                 0x17
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x0C0D170CU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x0C0D170CU);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x00030311U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x00030311U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x1205010EU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG11_OFFSET, 0x7F1F031FU, 0x1205010EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * /LPDDR4 devices.
    *  PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                   0x10f43

    * ZQ Control Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x02010F43U)
    */
	PSU_Mask_Write(DDRC_ZQCTL1_OFFSET, 0x3FFFFFFFU, 0x02010F43U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Refresh Period
    *  PSU_DDR_PHY_PGCR2_TREFPRD                                   0xa968

    * PHY General Configuration Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F0A968U)
    */
	PSU_Mask_Write(DDR_PHY_PGCR2_OFFSET, 0xFFFFFFFFU, 0x00F0A968U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Power-Down Time
    *  PSU_DDR_PHY_PTR0_TPLLPD                                     0x164

    * PLL Gear Shift Time
    *  PSU_DDR_PHY_PTR0_TPLLGS                                     0x58f

    * PHY Reset Time
    *  PSU_DDR_PHY_PTR0_TPHYRST                                    0x10

    * PHY Timing Register 0
    * (OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x2C8163D0U)
    */
	PSU_Mask_Write(DDR_PHY_PTR0_OFFSET, 0xFFFFFFFFU, 0x2C8163D0U);
/*##################################################################### */
    ...
    * PLL Lock Time
    *  PSU_DDR_PHY_PTR1_TPLLLOCK                                   0x8ae4

    * Reserved. Returns zeroes on reads.
    *  PSU_DDR_PHY_PTR1_RESERVED_15_13                             0x0

    * PLL Reset Time
    *  PSU_DDR_PHY_PTR1_TPLLRST                                    0xc80

    * PHY Timing Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0x8AE40C80U)
    */
	PSU_Mask_Write(DDR_PHY_PTR1_OFFSET, 0xFFFFFFFFU, 0x8AE40C80U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080068, 0xFFFFFFFFU ,0x03140000U)
    */
	PSU_Mask_Write(DDR_PHY_PLLCR0_OFFSET, 0xFFFFFFFFU, 0x03140000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x05180A06U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x05180A06U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x28190008U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x28190008U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x00B92B05U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x00B92B05U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00220A06U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00220A06U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_ZQCR_PGWAIT_FRQA                                0xe
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080680, 0xFFFFFFFFU ,0x0089CA58U)
    */
	PSU_Mask_Write(DDR_PHY_ZQCR_OFFSET, 0xFFFFFFFFU, 0x0089CA58U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * DATX8 n General Configuration Register 4
    * (OFFSET, MASK, VALUE)      (0XFD080D10, 0xFFFFFFFFU ,0x0C00B004U)
    */
	PSU_Mask_Write(DDR_PHY_DX6GCR4_OFFSET, 0xFFFFFFFFU, 0x0C00B004U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Frequency Select
    *  PSU_DDR_PHY_DX8SL0PLLCR0_FRQSEL                             0x3
    ...
    * (OFFSET, MASK, VALUE)      (0XFD081404, 0xFFFFFFFFU ,0x03140000U)
    */
	PSU_Mask_Write(DDR_PHY_DX8SL0PLLCR0_OFFSET,
		0xFFFFFFFFU, 0x03140000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Frequency Select
    *  PSU_DDR_PHY_DX8SL1PLLCR0_FRQSEL                             0x3
    ...
    * DAXT8 0-1 PLL Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD081444, 0xFFFFFFFFU ,0x03140000U)
    */
...
/*##################################################################### */
    ...
    * PLL Frequency Select
    *  PSU_DDR_PHY_DX8SL2PLLCR0_FRQSEL                             0x3
    ...
    * DAXT8 0-1 PLL Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD081484, 0xFFFFFFFFU ,0x23140000U)
    */
	PSU_Mask_Write(DDR_PHY_DX8SL2PLLCR0_OFFSET,
		0xFFFFFFFFU, 0x23140000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Frequency Select
    *  PSU_DDR_PHY_DX8SL3PLLCR0_FRQSEL                             0x3
    ...
    * DAXT8 0-1 PLL Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD0814C4, 0xFFFFFFFFU ,0x03140000U)
    */
...
/*##################################################################### */
    ...
    * PLL Frequency Select
    *  PSU_DDR_PHY_DX8SL4PLLCR0_FRQSEL                             0x3
    ...
    * DAXT8 0-1 PLL Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD081504, 0xFFFFFFFFU ,0x03140000U)
    */
...
/*##################################################################### */
    ...
    * PLL Frequency Select
    *  PSU_DDR_PHY_DX8SLBPLLCR0_FRQSEL                             0x3

    * Relock Mode
    *  PSU_DDR_PHY_DX8SLBPLLCR0_RLOCKM                             0x0

    * Charge Pump Proportional Current Control
    *  PSU_DDR_PHY_DX8SLBPLLCR0_CPPC                               0xa
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0817C4, 0xFFFFFFFFU ,0x03140000U)
    */
...
/*##################################################################### */
    ...
    * sed
    *  PSU_IOU_SLCR_MIO_PIN_22_L3_SEL                              5

    * Configures MIO Pin 22 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180058, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_22_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    * TTC Waveform Clock) 6= ua0, Output, ua0_txd- (UART transmitter serial ou
    * tput) 7= Not Used
    *  PSU_IOU_SLCR_MIO_PIN_23_L3_SEL                              5

    * Configures MIO Pin 23 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18005C, 0x000000FEU ,0x000000A0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_23_OFFSET, 0x000000FEU, 0x000000A0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_24_L2_SEL                              3
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180060, 0x000000FEU ,0x00000018U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_24_OFFSET, 0x000000FEU, 0x00000018U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x01640000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x01640000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B3F03FU)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B3F03FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL4_PULL_HIGH_LOW_N_BIT_24             0

    * Each bit applies to a single IO. Bit 0 for MIO[52].
    *  PSU_IOU_SLCR_BANK2_CTRL4_PULL_HIGH_LOW_N_BIT_25             0

    * When mio_bank2_pull_enable is set, this selects pull up or pull down for
    *  MIO Bank 2 - control MIO[77:52]
    * (OFFSET, MASK, VALUE)      (0XFF18017C, 0x03FFFFFFU ,0x00FFFFFFU)
    */
...
unsigned long psu_peripherals_init_data(void)
{
    ...
    * (OFFSET, MASK, VALUE)      (0XFD1A0100, 0x000F0046U ,0x00000000U)
    */
	PSU_Mask_Write(CRF_APB_RST_FPD_TOP_OFFSET, 0x000F0046U, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
    /*
    * Register : Clock_Control_1 @ 0XFF110000

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC0_CLOCK_CONTROL_1_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF110000, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC0_CLOCK_CONTROL_1_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_2 @ 0XFF110004

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC0_CLOCK_CONTROL_2_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF110004, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC0_CLOCK_CONTROL_2_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */

    /*
    * Register : Clock_Control_3 @ 0XFF110008

    * Clock Source: when this bit is set the counter uses the external clock i
    * nput, ext_clk; the default clock source is pclk.
    *  PSU_TTC0_CLOCK_CONTROL_3_C_SRC                              1

    * Clock Control register
    * (OFFSET, MASK, VALUE)      (0XFF110008, 0x00000020U ,0x00000020U)
    */
	PSU_Mask_Write(TTC0_CLOCK_CONTROL_3_OFFSET,
		0x00000020U, 0x00000020U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD410014, 0x00000077U ,0x00000032U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG1_OFFSET, 0x00000077U, 0x00000032U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_PCIE_ATTRIB_ID_CFG_DEV_ID                               0x6781

    * Vendor ID for the PCIe Cap Structure Vendor ID field
    *  PSU_PCIE_ATTRIB_ID_CFG_VEND_ID                              0x15ac

    * ID
    * (OFFSET, MASK, VALUE)      (0XFD480200, 0xFFFFFFFFU ,0x15AC6781U)
    */
	PSU_Mask_Write(PCIE_ATTRIB_ID_OFFSET, 0xFFFFFFFFU, 0x15AC6781U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * ATTR_25
    * (OFFSET, MASK, VALUE)      (0XFD480064, 0x000001FFU ,0x00000005U)
    */
	PSU_Mask_Write(PCIE_ATTRIB_ATTR_25_OFFSET, 0x000001FFU, 0x00000005U);
/*##################################################################### */
...
/* Run Vref training in static read mode*/
	...
	Xil_Out32(0xFD080018U, 0x00F0141AU);
...
/*Vref training is complete, disabling static read mode*/
	...
	Xil_Out32(0xFD080018U, 0x00F0C16AU);
